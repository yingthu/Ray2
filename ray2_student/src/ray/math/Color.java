...
public class Color {
	...
	/**
	 * Set all components to the given constant value.
	 * @param c the constant value to be set to all components
	 */
	...
	/**
	 * Scales the components of this color by the specified three factors. 
	 */
	public void scale(double sr, double sg, double sb)
	{
		this.r *= sr;
		this.g *= sg;
		this.b *= sb;
	...
	/**
	 * @return true if the three components are very close to zero
	 */
	public boolean isZero()
	{
		return r < 1e-9 && g < 1e-9 && b < 1e-9;
	}
}