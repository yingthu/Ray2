...
public class Sphere extends Surface {
  ...
  public void computeBoundingBox() {
    ...
    // Vertices of the box
    v[0].add(new Vector3(-radius, -radius, -radius));
    v[1].add(new Vector3(-radius, radius, -radius));
    v[2].add(new Vector3(radius, -radius, -radius));
    v[3].add(new Vector3(radius, radius, -radius));
    v[4].add(new Vector3(-radius, -radius, radius));
    v[5].add(new Vector3(-radius, radius, radius));
    v[6].add(new Vector3(radius, -radius, radius));
    v[7].add(new Vector3(radius, radius, radius));
